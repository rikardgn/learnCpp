...
class mp3FileList{
    ...
    public:
        ...
        void initClass(std::string strMp3Path, long numFiles, std::string dstDir, int* ptrRandList, int numRandNr){
            //set Vars
            mp3FileList::strMp3Path = strMp3Path;
            mp3FileList::numFiles = numFiles;
            mp3FileList::dstDir = dstDir;
...
int main(void){
    ...
    mp3FileList mp3List(strMp3Dir, numItems, dstDir, ranNumList.retPtrArrInt(), ranNumList.retNumItems() );
    //mp3List.initClass(strMp3Dir, numItems, dstDir, ranNumList.retPtrArrInt(), ranNumList.retNumItems() );
