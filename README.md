...
- Shows how to use random number generator fromnm newer c++ standard to generate normal distributions
  The program lets you chose what seed to use to what effect it has on the randomness of the numbers
Pointers
-------
- intPtr.cpp
