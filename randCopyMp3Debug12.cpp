...
class randNumList{
    ...
    public:
    randNumList(std::string strMp3Path){
...
int main(void){
    ...
    randNumList ranNumList(strMp3Dir);
    nrFilesCopy=(procFilesCopy/100)*ranNumList.retNumFiles();
    numItemsRanList = (int)( (procFilesCopy/100)*ranNumList.retNumFiles() );
    ranNumList.createList(numItemsRanList);
