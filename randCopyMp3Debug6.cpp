...
class mp3FileList{
    ...
    void initClass(std::string strMp3Path, long numFiles){
...
int main(void){
    ...
    mp3List.initClass(strMp3Dir, numItems);
    //Add this function to the initClass function.
    //27th dec 2023
    //mp3List.cntMp3sDir();
    //if this function works, remove it and setting of this var to the initClass function
    //mp3List.setNumFiles(numItems);
